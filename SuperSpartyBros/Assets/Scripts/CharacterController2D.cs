...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
		...
		else if(canDoubleJump && CrossPlatformInputManager.GetButtonDown("Jump")) // If grounded AND jump button pressed, then allow the player to jump
		{
			DoJump();
			canDoubleJump = false;
		}
